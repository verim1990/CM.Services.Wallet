...
using CM.Services.Wallet.Infrastracture.Mappings;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Design;
using System.Threading.Tasks;

namespace CM.Services.Wallet.Infrastracture.Contexts
{
    ...
    public class ApplicationContextDesignFactory : IDesignTimeDbContextFactory<ApplicationContext>
    {
        public ApplicationContext CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<ApplicationContext>()
                .UseSqlServer("Server=tcp:127.0.0.1,5433;Database=CM_Services_WalletDb;User Id=SA;Password=Test1990!;");
